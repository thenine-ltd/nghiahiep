jQuery(function($) {
    ...
    $( '#menu-to-edit' ).on( 'sortstop', function() {
        $(this).find( '.menu-item' ).each( function() {
            var $image_select = $(this).find('.field-norebro_mega_menu_image');
            var $image_position = $(this).find('.field-norebro_mega_menu_bg_position');
            var $image_repeat = $(this).find('.field-norebro_mega_menu_bg_repeat');
