<?php if ( function_exists( 'acf_add_local_field_group' ) ) :
    ...
    acf_add_local_field_group( [
        ...
        "title" => __( 'Product Settings', 'norebro' ),
        "private" => true,
        "fields" => [
            [
            ...
            [
                "key" => "field_5937e0a52b48cexmod32",
                "label" => __( '', 'norebro' ),
                "name" => "",
                "type" => "message",
                "instructions" => "",
                "required" => 0,
                "conditional_logic" => 0,
                "message" => "<p class=\"message\"><span class=\"icon ion-information-circled\"></span> <b>Note:</b> to find more shop options navigate to global settings <b>Theme Settings > Shop Settings</b></p>",
                "new_lines" => "",
                "esc_html" => 0
            ],
            [
            ...
            [
                ...
                "type" => "norebro_responstive_height",
            ...
            [
                ...
                "label" => __( 'Full width wrapper', 'norebro' ),
                "name" => "full_width_margins_type",
                "type" => "radio",
                "instructions" => __( 'Set custom value for this page', 'norebro' ),
                "required" => 0,
                "conditional_logic" => 0,
                "choices" => [
                    "inherit" => __( 'Use from Page Settings', 'norebro' ),
