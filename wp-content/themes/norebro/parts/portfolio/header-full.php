...
<!-- Content -->
<div class="portfolio-page header-full" id="scroll-portfolio" data-norebro-bg-image="<?php if ( $featured_image && $featured_image_thumbnail ) { echo esc_url( $featured_image_thumbnail ); } else { echo esc_url( array_shift( $project['images'] ) ); } ?>">
