	...
	<div class="clb-hub-intro">
		<div class="clb-hub-container">
			<div class="details">
				...
				<h1><?php _e( 'Dashboard', 'norebro-extra' ); ?></h1>
			</div>
			<div class="mode-switcher">
				<a href="admin.php?page=norebro_hub" class="btn btn-flat"><?php _e( 'Dashboard', 'norebro-importer' ); ?></a>
		...
		<div class="clb-hub-container clb-page-container">
			...
			<div id="tabs" class="clb-nav">
				<ul class="clb-nav-inner">
					<li><a href="#tabs-1" class="selected"><?php _e( 'Registration', 'norebro-extra' ); ?></a></li>
					<li><a href="#tabs-2"><?php _e( 'What’s New', 'norebro-extra' ); ?></a></li>
					<li><a href="#tabs-3"><?php _e( 'System Status', 'norebro-extra' ); ?></a></li>
					<li><a href="#tabs-4"><?php _e( 'Help Center', 'norebro-extra' ); ?></a></li>
					<li><a href="#tabs-5"><?php _e( 'FAQs', 'norebro-extra' ); ?></a></li>
				</ul>
