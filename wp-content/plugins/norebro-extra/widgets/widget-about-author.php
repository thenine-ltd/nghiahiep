...
if ( ! class_exists( 'norebro_widget_about_author' ) ) {

	class norebro_widget_about_author extends SB_WP_Widget {
		...
		public function __construct() {		
			...
			parent::__construct(
				'norebro_widget_about_author',
				'Norebro: ' . esc_html__( 'About author', 'norebro-extra' ),
				array( 'description' => esc_html__( 'About author', 'norebro-extra' ) )
			);
		}
		...
		public function widget( $args, $instance ) {
			...
			printf( '<img src="%s" alt="' . esc_html__( 'Author avatar', 'norebro-extra' ) . '" />', get_avatar_url( $author ) );
			?>
				<div class="info">
					<div class="info-wrap">
						<div class="socialbar">
...
register_widget( 'norebro_widget_about_author' );