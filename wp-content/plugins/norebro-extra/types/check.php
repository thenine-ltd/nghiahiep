<?php
	...
	/**
	* WPBakery Norebro Check custom type
	*/

	if ( function_exists ( 'vc_add_shortcode_param' ) ) {
		vc_add_shortcode_param( 'norebro_check', 'norebro_extra_check_settings_field', plugins_url( 'check.js' , __FILE__ ) );
	}
	
	function norebro_extra_check_settings_field( $settings, $value ) {
		...
		ob_start();
?>
		<div class="norebro_extra_check_block">
