<?php
	...
	/**
	* WPBakery Page Builder Norebro Choose box custom type
	*/
	if ( function_exists ( 'vc_add_shortcode_param' ) ) {
		vc_add_shortcode_param( 'norebro_choose_box', 'norebro_extra_choose_box_settings_field', plugins_url( 'choose_box.js' , __FILE__ ) );
	}

	function norebro_extra_choose_box_settings_field( $settings, $value ) {
...
?>
		<div class="norebro_extra_choose_box_block">
				...
				<?php foreach ($settings['value'] as $option) { ?>
					<li>
						...
						<label>
							...
							<p class="norebro_extra_choose_box_title"><?php echo $option['title']; ?></p>
						</label>
					</li>
				<?php } ?>
			</ul>
