...
if ( !window.useNorIconPicker ){
	...
	// Toggle content
	function NorebroExtraIconPickerToggleContent( select ){
	...
	// Select click
	$('body').on('click', '.norebro_extra_icon_picker_block .selected-icon', function(){
		NorebroExtraIconPickerToggleContent( $(this) );
	});


	// Icon click
	$('body').on('click', '.norebro_extra_icon_picker_block .icons li li', function(){
		var select = $(this).closest('.norebro_extra_icon_picker_block'),
		...
		NorebroExtraIconPickerToggleContent( select );

	});


	// Category change
	$('body').on('change', '.norebro_extra_icon_picker_block .categories', function(){
		var current_category = $(this).val(),
			select = $(this).closest('.norebro_extra_icon_picker_block'),
	...
	// Search
	$('body').on('input', '.norebro_extra_icon_picker_block input.search', function(){
		var value = $(this).val(),
			select = $(this).closest('.norebro_extra_icon_picker_block'),
			categories = select.find('.icons > li'),
			icons = select.find('.icons ul > li'),
