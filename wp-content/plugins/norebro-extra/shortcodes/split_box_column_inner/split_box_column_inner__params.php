...
/**
* WPBakery Norebro Split Box Column Inner shortcode params
*/

vc_map( array(
	'name' => __( 'Split Box Column', 'norebro-extra' ),
	'description' => __( 'Split box column', 'norebro-extra' ),
	'base' => 'norebro_split_box_column_inner',
	'category' => __( 'Norebro', 'norebro-extra' ),
	'js_view' => 'VcNorebroSplitBoxColumnInnerView',
	'show_settings_on_create' => false,
	'is_container' => true,
	'as_child' => array( 
		'only' => 'norebro_split_box_inner'
	),
));


if ( class_exists( 'WPBakeryShortCodesContainer' ) ) {
	class WPBakeryShortCode_Norebro_Split_Box_Column_Inner extends WPBakeryShortCodesContainer {
