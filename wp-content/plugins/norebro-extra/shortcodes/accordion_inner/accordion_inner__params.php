...
/**
* WPBakery Norebro Accordion Inner shortcode params
*/

vc_map( array(
	'name' => __( 'Tab', 'norebro-extra' ),
	'description' => __( 'Norebro accordion tab', 'norebro-extra' ),
	'base' => 'norebro_accordion_inner',
	'category' => __( 'Norebro', 'norebro-extra' ),
	'allowed_container_element' => 'vc_row',
	'is_container' => true,
	'show_settings_on_create' => false,
	'as_child' => array(
		'only' => 'norebro_accordion',
	),
	'js_view' => 'VcBackendTtaSectionView',
	'custom_markup' => '
		<div class="vc_tta-panel-heading">
			<h4 class="vc_tta-panel-title vc_tta-controls-icon-position-left"><a href="javascript:;" data-vc-target="[data-model-id=\'{{ model_id }}\']" data-vc-accordion data-vc-container=".wpb_norebro_accordion"><span class="vc_tta-title-text">{{ section_title }}</span><i class="vc_tta-controls-icon vc_tta-controls-icon-plus"></i></a></h4>
		</div>
	...
	'params' => array(
		...
		array(
			...
			'heading' => __( 'Heading', 'norebro-extra' ),
			'param_name' => 'heading',
			'description' => __( 'Accordion tab title.', 'norebro-extra' ),
		),
		array(
			'type' => 'textarea_html',
			'group' => __( 'General', 'norebro-extra'),
		...
		array(
			...
			'group' => __( 'General', 'norebro-extra' ),
			'heading' => __( 'Tab unique ID', 'norebro-extra' ),
			'description' => __( 'Enter section ID (Note: make sure it is unique and valid according to w3c specification).', 'norebro-extra' ),
		),
		...
		array(
			...
			'description' => __( 'Note that the tabs with icons for many informative.', 'norebro-extra' ),
		...
		array(
			...
			'value' => __( 'Tab heading', 'norebro-extra' ),
		),
		array(
		...
		array(
			...
			'heading' => __( 'Heading text color', 'norebro-extra' ),
			'param_name' => 'heading_text_color'
		),
		array(
			'type' => 'norebro_colorpicker',
			'group' => __( 'Styles', 'norebro-extra' ),
			'heading' => __( 'Content text color', 'norebro-extra' ),
		...
		array(
			'type' => 'norebro_colorpicker',
			'group' => __( 'Styles', 'norebro-extra' ),
			'heading' => __( 'Heading background fill', 'norebro-extra' ),
...
if ( class_exists( 'VcShortcodeAutoloader' ) ) {
	...
	class WPBakeryShortCode_Norebro_Accordion_Inner extends WPBakeryShortCode_VC_Tta_Accordion {
