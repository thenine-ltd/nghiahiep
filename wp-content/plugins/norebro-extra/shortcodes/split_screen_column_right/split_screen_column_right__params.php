...
/**
* WPBakery Norebro Split Screen Right Column shortcode params
*/

vc_map( array(
	'name' => __( 'Split Screen Column', 'norebro-extra' ),
	'description' => __( 'Split screen column', 'norebro-extra' ),
	'base' => 'norebro_split_screen_column_right',
...
if ( class_exists( 'WPBakeryShortCodesContainer' ) ) {
	class WPBakeryShortCode_Norebro_Split_Screen_Column_Right extends WPBakeryShortCodesContainer {
