...
/**
* WPBakery Norebro Tabs Inner shortcode params
*/

vc_map( array(
	'name' => __( 'Tab', 'norebro-extra' ),
	'description' => __( 'Accordion tab', 'norebro-extra' ),
	'base' => 'norebro_tabs_inner',
	...
	'custom_markup' => '
		<div class="vc_tta-panel-heading">
			<h4 class="vc_tta-panel-title vc_tta-controls-icon-position-left"><a href="javascript:;" data-vc-target="[data-model-id=\'{{ model_id }}\']" data-vc-accordion data-vc-container=".wpb_norebro_tabs"><span class="vc_tta-title-text">{{ section_title }}</span><i class="vc_tta-controls-icon vc_tta-controls-icon-plus"></i></a></h4>
		</div>
...
if ( class_exists( 'VcShortcodeAutoloader' ) ) {
	...
	class WPBakeryShortCode_Norebro_Tabs_Inner extends WPBakeryShortCode_VC_Tta_Accordion {
