...
/**
* WPBakery Norebro Carousel Inner shortcode params
*/

vc_map( array(
	'name' => __( 'Section', 'norebro-extra' ),
	'description' => __( 'Carousel section', 'norebro-extra' ),
	'base' => 'norebro_carousel_inner',
	'category' => __( 'Norebro', 'norebro-extra' ),
	'allowed_container_element' => 'vc_row',
	'is_container' => true,
	'show_settings_on_create' => false,
	'as_child' => array(
		'only' => 'norebro_carousel',
	),
	'js_view' => 'VcBackendTtaSectionView',
	'custom_markup' => '
		<div class="vc_tta-panel-heading">
			<h4 class="vc_tta-panel-title vc_tta-controls-icon-position-left"><a href="javascript:;" data-vc-target="[data-model-id=\'{{ model_id }}\']" data-vc-accordion data-vc-container=".wpb_norebro_carousel"><span class="vc_tta-title-text">{{ section_title }}</span><i class="vc_tta-controls-icon vc_tta-controls-icon-plus"></i></a></h4>
		</div>
	...
	'params' => array(
		...
		array(
			...
			'param_name' => 'title',
			'description' => __( 'Tab title.', 'norebro-extra' ),
		),
		array(
			'type' => 'el_id',
			'param_name' => 'tab_id',
...
if ( class_exists( 'VcShortcodeAutoloader' ) ) {
	...
	class WPBakeryShortCode_Norebro_Carousel_Inner extends WPBakeryShortCode_VC_Tta_Accordion {
